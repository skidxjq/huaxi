 ...
 */
app.controller('diseaseFeeCtrl', ['$scope','$http',function($scope,$http) {
        ...
        yAxis: [
            {
                ...
                type: 'category',
                data: $scope.config.mock.diseaseSets.slice(0,10)
            }
        ],
        xAxis: [
            {
        ...
        yAxis: [
            {
                ...
                type: 'category',
                data: $scope.config.mock.diseaseSets.slice(0,10).reverse()
            }
        ],
        xAxis: [
            {
